# -*- coding: utf-8 -*-
"""bearing_classify.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13nANrfjmkL6XwppN6IWSaHTNGZ3sXBge
"""
...
my_data_dir = '/content/drive/MyDrive/archive/casting_data/casting_data/'
...
# view some images
img = plt.imread('/content/drive/MyDrive/archive/casting_data/casting_data/train/def_front/1.jpeg')
...
results = model.fit_generator(train_set,epochs=2,
...
img1 = cv2.imread(test_path+'ok_front/crt_image1-compressed.jpg',0)
img1 = img1/255
pred_img1 =img1.copy()
...
model.save('final_team8.h5')

import tensorflow as tf
import pathlib

export_dir='inspection_team8'
